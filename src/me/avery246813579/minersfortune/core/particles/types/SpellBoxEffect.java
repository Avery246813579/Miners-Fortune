...
public class SpellBoxEffect extends IParticle{
	public SpellBoxEffect(Location location) {
		super(location, IParticleActions.BOX, IParticleType.MOB_SPELL);
	}
	
	public SpellBoxEffect(Player player) {
		super(player, IParticleActions.BOX, IParticleType.MOB_SPELL);
	}
}