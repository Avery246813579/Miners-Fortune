...
public class KitInfoCommand extends GameCommand{
	public KitInfoCommand() {
		super("kitinfo", Ranks.DEFAULT, new ArrayList<GameState>(Arrays.asList(GameState.Prepare, GameState.Recruit)));
	...
	protected void runCommand(CommandSender sender, String[] args) {
		if(args.length == 0){
			sendCommandMessage(sender, ChatColor.RED + "Usage: " + ChatColor.YELLOW + "/KitInfo (Kit Name)");
			return;
		}
		...
		gamePlayer.displayKitInfo(GameManager.findKit(args[0]));
	}
}
