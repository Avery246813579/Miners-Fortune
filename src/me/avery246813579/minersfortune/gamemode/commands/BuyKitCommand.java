...
public class BuyKitCommand extends GameCommand{
	public BuyKitCommand() {
		super("buykit", Ranks.DEFAULT, new ArrayList<GameState>(Arrays.asList(GameState.Prepare, GameState.Recruit)));
	...
	protected void runCommand(CommandSender sender, String[] args) {
		if(args.length == 0){
			sendCommandMessage(sender, ChatColor.RED + "Usage: " + ChatColor.YELLOW + "/BuyKit (Kit Name)");
			return;
		}
		...
		gamePlayer.buyKit(GameManager.findKit(args[0]));
	}
}
